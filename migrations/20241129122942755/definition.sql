...
--
-- Class LinkedAccount as table linked_account
--
...
--
-- Foreign relations for "linked_account" table
--
...
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('tradelog', '20241129122942755', now())
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20241129122942755', "timestamp" = now();
